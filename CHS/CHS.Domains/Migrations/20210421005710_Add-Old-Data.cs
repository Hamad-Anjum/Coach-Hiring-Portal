...
{
    public partial class AddOldData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvaiableSpace = table.Column<bool>(type: "bit", nullable: false),
                    TotalCapacity = table.Column<int>(type: "int", nullable: false),
                    IsHotelGym = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Index = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Index = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvaiableToHireOrSpaceAvailable = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    GroupTrainer = table.Column<bool>(type: "bit", nullable: false),
                    PrivateTrainer = table.Column<bool>(type: "bit", nullable: false),
                    WillingToTravel = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TC_Accept = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FilledSurveyForm = table.Column<bool>(type: "bit", nullable: false),
                    GenderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    YearsOfExperience = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    YearsAsTraining = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Index = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemberAlerts_AlertTypes_AlertTypeId",
                        column: x => x.AlertTypeId,
                        principalTable: "AlertTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberAlerts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberCertifications_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberLanguages", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberNotes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExpertLevel = table.Column<double>(type: "float", nullable: false),
                    YearsInTraining = table.Column<double>(type: "float", nullable: false),
                    YearsAsTrainer = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberSkills_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SubscriptionMonths = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SubscriptionOwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Index = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_AspNetUsers_SubscriptionOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerLevel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerLevel_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GymSubscriptions_Subscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberSubscriptions_AspNetUsers_SubscriberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTimings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTimings_Subscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymSubscriptions_SubscriptionId",
                table: "GymSubscriptions",
                column: "SubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberAlerts_AlertTypeId",
                table: "MemberAlerts",
                column: "AlertTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberAlerts_ApplicationUserId",
                table: "MemberAlerts",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberCertifications_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberNotes_ApplicationUserId",
                table: "MemberNotes",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberSkills_ApplicationUserId",
                table: "MemberSkills",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberSubscriptions_SubscriberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_SubscriptionOwnerId",
                table: "Subscriptions",
                column: "SubscriptionOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTimings_SubscriptionId",
                table: "SubscriptionTimings",
                column: "SubscriptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerLevel_ApplicationUserId",
                table: "TrainerLevel",
                column: "ApplicationUserId");
        }
