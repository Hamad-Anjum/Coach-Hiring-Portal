...
namespace CHS.Domains.Migrations
{
    ...
    [Migration("20210518220747_Added-Chat_Module")]
    partial class AddedChat_Module
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.GroupMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.GroupUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.MessageLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.Group", b =>
                {
                    b.HasOne("CHS.Domains.Models.ApplicationUser", "AdminUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.GroupMessage", b =>
                {
                    b.HasOne("CHS.Domains.Models.Chat.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CHS.Domains.Models.ApplicationUser", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.Message", b =>
                {
                    b.HasOne("CHS.Domains.Models.ApplicationUser", "ReceiverUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CHS.Domains.Models.Chat.MessageLike", b =>
                {
                    b.HasOne("CHS.Domains.Models.Chat.GroupMessage", "GroupMessage")
                        .WithMany()
                        .HasForeignKey("GroupMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CHS.Domains.Models.ApplicationUser", "LikeeUser")
                        .WithMany()
