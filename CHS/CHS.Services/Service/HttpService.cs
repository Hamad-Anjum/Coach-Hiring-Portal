...
namespace CHS.Services.Service
{
    public class HttpService : IHttpService
    {
        ...
        public HttpService(ProtectedLocalStorage localStorage, HttpClient httpClient, AuthenticationStateProvider authenticationStateProvider)
        {
        ...
        public async Task<HttpResponseMessage> SendRequest(string httpMethod, string url, bool isSite = false, string serializedData = null)
        {
            ...
            if (!isSite)
            {
                ...
                {
                    await ((CustomAuthenticationStateProvider)_authenticationStateProvider).MarkUserAsNotAuthenticated();
                }
            }
            return response;
        }
